...
type Company struct {
	...
	CompanyProperties string `json:"companyProperties"`
}
...
type GoogleSheetsSettings struct {
	...
	UpdatedIssuesAt string  `json:"updatedIssuesAt"`
}
...
type OpsgenieInput struct {
	...
	APIFailedWithUnauthorizedErrorAt string `json:"apiFailedWithUnauthorizedErrorAt"`
}
...
type OrganizationUpdateInput struct {
	...
	LinearPreviewFlags *string `json:"linearPreviewFlags,omitempty"`
...
func (e ProjectTab) IsValid() bool {
	switch e {
	case ProjectTabDocuments, ProjectTabIssues, ProjectTabActivity:
		return true
	}
	return false
}
...
func (e SLAStatus) IsValid() bool {
	switch e {
	case SLAStatusBreached, SLAStatusHighRisk, SLAStatusMediumRisk, SLAStatusLowRisk, SLAStatusCompleted, SLAStatusFailed, SLAStatusPaused:
		return true
	}
	return false
}
